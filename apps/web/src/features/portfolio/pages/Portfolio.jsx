...
const Portfolio = () => {
  ...
  // Otherwise, show the premium marketing landing page
        ...
        <div className="relative">
          ...
          <motion.section className="content-width mx-auto grid gap-10 md:grid-cols-2 items-center py-24" initial="initial" whileInView="animate" viewport={{ once: true, margin: '-100px' }}>
            <div className="space-y-8">
              ...
              <button type="button" onClick={openWalletModal} className="mt-6 px-6 py-3 rounded-full bg-orange-500 hover:bg-orange-600 text-black font-semibold transition">
                Connect Portfolio
              </button>
            </div>
